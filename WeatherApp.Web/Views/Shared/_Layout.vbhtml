...
<head>
    ...
    <title>@ViewBag.Title - Worldwide Weather Forcast</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse d-sm-inline-flex justify-content-between">
                <ul class="navbar-nav flex-grow-1">
                    ...
                    <li>@Html.ActionLink("Locations", "Index", "UserLocation", New With {.area = ""}, New With {.class = "nav-link"})</li>
    ...
    <div class="container body-content">
        ...
        <hr />
        <footer>
            <p>&copy; @DateTime.Now.Year - Dean Swift</p>
        </footer>
    </div>
